...
var (
	...
	DefaultConfig = Config{
		CacheSize:                   8 * units.GiB,       // Optimized: 512 MB to 8 GB
		BytesPerSync:                1 * units.MiB,       // More frequent sync: 512 KB to 1 MB
		WALBytesPerSync:             0,                   // Default to no background syncing.
		MemTableStopWritesThreshold: 4,                   // More aggressive: 8 to 4
		MemTableSize:                256 * units.MiB,     // Larger batches: 128 MB to 256 MB
		MaxOpenFiles:                16384,               // Better concurrent access: 4096 to 16384
		MaxConcurrentCompactions:    2,                   // Parallel compaction: 1 to 2
